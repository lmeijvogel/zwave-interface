...
namespace MyZWave {
  ...
  void LightsController::SetProgramme( Programme programme ) {
    ...
    switch (programme) {
      case Programme_Off:     uplightIntensity     =  0;
                              coffeeTableOn        = false;
                              diningTableIntensity =  0;
                              kitchenIntensity     =  0;
      break;
      case Programme_Morning: uplightIntensity     =  0;
                              coffeeTableOn        = true;
                              diningTableIntensity = 99;
                              kitchenIntensity     = 99;
      break;
      case Programme_Regular: uplightIntensity     = 99;
                              coffeeTableOn        = false;
                              diningTableIntensity = 99;
                              kitchenIntensity     = 99;
      break;
      case Programme_Dimmed:  uplightIntensity     = 40;
                              coffeeTableOn        = false;
                              diningTableIntensity = 50;
                              kitchenIntensity     = 40;
      break;
      case Programme_Night:   uplightIntensity     = 25;
                              coffeeTableOn        = false;
                              diningTableIntensity =  0;
                              kitchenIntensity     = 40;
      break;
